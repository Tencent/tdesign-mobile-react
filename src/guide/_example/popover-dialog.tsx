...
export default function Demo() {
  ...
  const steps: TdGuideProps['steps'] = [
    {
      element: '.popover-dialog-guide .main-title',
      title: '用户引导标题',
      body: '用户引导的说明文案',
      placement: 'center',
    },
    {
      element: '.popover-dialog-guide .label-field',
      title: '用户引导标题',
      body: DialogBody,
      mode: 'dialog',
    },
    {
      element: '.popover-dialog-guide .action',
      title: '用户引导标题',
      body: '用户引导的说明文案',
  ...
  return (
    <div className="guide-demo">
      ...
      <Popup visible={visible} placement="bottom" style={{ height: '100vh', borderRadius: 0 }} destroy-on-close>
        <div>
          <div className="guide-container popover-dialog-guide">
