...
class Picker {
  ...
  getLiElements(): HTMLLIElement[] {
    const liElements = Array.from(this.holder.querySelectorAll('li')) || [];
    return liElements;
  }
   ...
   */
  updateItems(): void {
    this.elementItems = [...this.getLiElements()];
  ...
  initScrollParams(): void {
    ...
    this.itemClassName = `${this.prefix}-picker-item__item`;
    this.itemSelectedClassName = `${this.prefix}-picker-item__item--active`;
