    ...
    <>
      <TDemoBlock title="01 类型" summary="基础选择器">
        <Cell
          arrow
          title="城市"
          note={NotePanel(state.city.labelText, '选择城市')}
          onClick={() => togglePicker('city', true)}
        />
        <Picker
      ...
      <TDemoBlock title="" summary="带标题选择器">
        <Cell
          arrow
          title="城市"
          note={NotePanel(state.titleCity.labelText, '选择城市')}
          onClick={() => togglePicker('titleCity', true)}
        />
        <Picker
